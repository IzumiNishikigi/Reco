...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final AndrognitoLibraryAccessors laccForAndrognitoLibraryAccessors = new AndrognitoLibraryAccessors(owner);
    ...
    private final ItsxttLibraryAccessors laccForItsxttLibraryAccessors = new ItsxttLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>patternlockview</b> with <b>com.itsxtt.patternlockview:patternlockview</b> coordinates and
    ...
    /**
     * Group of libraries at <b>andrognito</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public AndrognitoLibraryAccessors getAndrognito() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForAndrognitoLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>itsxtt</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public ItsxttLibraryAccessors getItsxtt() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForItsxttLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class AndrognitoLibraryAccessors extends SubDependencyFactory {

        public AndrognitoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>patternlockview</b> with <b>com.andrognito:patternlockview</b> coordinates and
         * with version reference <b>patternlockviewVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getPatternlockview() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("andrognito.patternlockview");
        }
     ...
     */
    @Deprecated
    public static class ItsxttLibraryAccessors extends SubDependencyFactory {

        public ItsxttLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>patternlockview</b> with <b>com.github.itsxtt:patternlockview</b> coordinates and
         * with version reference <b>githubPatternlockview</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getPatternlockview() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("itsxtt.patternlockview");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>githubPatternlockview</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGithubPatternlockview() { return getVersion("githubPatternlockview"); }
        ...
        /**
         * Version alias <b>kotlinStdlib</b> with value <b>1.9.23</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>patternlockview</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>patternlockviewVersion</b> with value <b>1.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPatternlockviewVersion() { return getVersion("patternlockviewVersion"); }
